...
public class uicc_register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent intent=new Intent(uicc_register.this, TeamRegistrations.class);

                    intent.putExtra("event","uicc");
                    intent.putExtra("url","https://www.hackerearth.com/challenges/college/UICC20/");
    ...
    private void download()
    {
        ...
        ref=storageReference.child("coding_challenge.pdf");
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onSuccess(Uri uri) {
                ...
                downloadFile(uicc_register.this,"UICC",".pdf", Environment.DIRECTORY_DOWNLOADS,url);
            }
