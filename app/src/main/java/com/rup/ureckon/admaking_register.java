...
public class admaking_register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent intent=new Intent(admaking_register.this, TeamRegistrations.class);

                    intent.putExtra("event","admaking");
                    intent.putExtra("url","https://docs.google.com/forms/d/e/1FAIpQLSdBSuPooUlWpXfnCPbs3JFnB_xWuf8yzyT7KQb4hqLr5dpfkA/viewform");
    ...
    private void download()
    {
        ...
        ref=storageReference.child("ad_mad.pdf");
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onSuccess(Uri uri) {
                ...
                downloadFile(admaking_register.this,"ad_mad",".pdf", Environment.DIRECTORY_DOWNLOADS,url);
            }
